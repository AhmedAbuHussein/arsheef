            ...
            <div class="d-flex align-items-center justify-content-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('admin.Setting') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
                        ...
                        <form action="{{ route('admin.setting.edit', ['setting'=>$setting, 'type'=> $type]) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-md-6 offset-md-3 block-center mb-3">
                                <label for="img" id="label-img">
                                    <img style="cursor: pointer;" class="preview" src="{{ url($setting->value_lang) }}" title="Choose image" />
                                </label>
                            ...
                            <div class="form-group col-md-6 offset-md-3 block-center">
                                <label for="value">{{ __('admin.First Word') }}</label>
                            ...
                            <div class="form-group col-md-6 offset-md-3 block-center">
                                <label for="value1">{{ __('admin.Second Word') }}</label>
                            ...
                            <div class="form-group col-md-6 offset-md-3 block-center">
                                <label for="value2">{{ __('admin.Third Word') }}</label>
                            ...
                            <hr />
                            <div class="form-group col-md-6 offset-md-3 block-center">
                                <label for="value">{{ __('admin.First Word Arabic') }}</label>
                            ...
                            <div class="form-group col-md-6 offset-md-3 block-center">
                                <label for="value1">{{ __('admin.Second Word Arabic') }}</label>
                            ...
                            <div class="form-group col-md-6 offset-md-3 block-center">
                                <label for="value2">{{ __('admin.Third Word Arabic') }}</label>
                            ...
                            <div class="form-group col-md-6 offset-md-3 block-center">
                                <label for="google">{{ __('admin.Google Plus') }}</label>
                            ...
                            <div class="form-group col-md-6 offset-md-3 block-center">
                                <label for="pinterest">{{ __('admin.Pinterest') }}</label>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label for="txt-editor">{{ __('admin.Value In English') }}</label>
                                ...
                                <div class="form-group col-md-6">
                                    <label for="txt-editor1">{{ __('admin.Value In Arabic') }}</label>
                            ...
                            <div class="form-group col-md-6 offset-md-3 block-center">
                                <button class="btn btn-primary btn-block"><i class="fa fa-send"></i> {{ __('admin.Process') }}</button>
                            </div>
