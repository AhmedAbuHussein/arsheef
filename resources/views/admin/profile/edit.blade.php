    ...
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-5 align-self-center">
                <h4 class="page-title">{{ __('admin.Admin') }}</h4>
            </div>
       ...
       <div class="row">
           <div class="col-md-10 mr-auto ml-auto">
                <form action="{{ route('admin.profile.update') }}" method="POST">
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                            <label for="oldpassword" class="control-label">{{ __('admin.Old Password') }}</label>
                        </div>
                        <div class="col-md-8">
                    ...
                    <div class="form-group row">
                        <div class="col-md-4">
                            <label for="confirm" class="control-label">{{ __('admin.Confirm Password') }}</label>
                        </div>
                        <div class="col-md-8">
