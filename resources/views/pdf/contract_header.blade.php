    ...
    <table>
        <tr class="no-border">
            <td style="width: 34.35%" class="no-border">
                ...
                <p class="mb-10 text-center" style="text-align: center;"><span class="text-bold">السجل التجاري :</span><span>{{ arabicNumbers($user->information->commerical_register) }}</span></p>
                <p class="mb-10 text-center" style="text-align: center;"><span class="text-bold"> ترخيص رقم :</span><span>{{  arabicNumbers($user->information->license_number) }}</span></p>
            </td>
            ...
            <td style="width: 34.31%" class="no-border">
                ...
                <p class="text-center" style="text-align: center">{{ arabicNumbers($user->information->phone) }}</p>
            </td>
        </tr>
    </table>
