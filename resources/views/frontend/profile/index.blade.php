            ...
            <div class="d-flex align-items-center justify-content-end">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('file.profile') }}</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-body">    
                    <div class="row custom-row">
                        <div class="col-md-12">
                            <a href="{{ route('profile.edit', ['type'=> 'profile']) }}" class="btn btn-block btn-outline-dark">{{ __('file.edit') }}</a>
                        </div>
                    </div>                
                    <div class="row custom-row">
                    ...
                    <div class="row custom-row">
                        <div class="col-md-4"> {{ __('file.email') }}</div>
                    ...
                    <div class="row custom-row">
                        ...
                        <div class="col-md-8">
                            <img src="{{ $user->image?url($user->image):url('user.png') }}" alt="image" style="width: 80%;border-radius:100%" />
                        </div>
                    </div>
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">      
                    <div class="row custom-row">
                        <div class="col-md-12">
                            <a href="{{ route('profile.edit', ['type'=> 'info']) }}" class="btn btn-block btn-outline-dark">{{ __('file.edit') }}</a>
                        </div>
                    </div>
                    <div class="row custom-row">
