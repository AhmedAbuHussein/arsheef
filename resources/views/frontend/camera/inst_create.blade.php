    ...
    <form method="POST" enctype="multipart/form-data" action="{{ route('create', ['type'=> $type]) }}">
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-4">
            ...
            <input type="text" name="est_name" value="{{ old('est_name') }}" class="form-control" id="est_name" required />
            @error('est_name')
                <div class="text-danger">{{ $message }}</div>
            @enderror
          </div>
        ...
        <div class="form-row">
          <div class="form-group col-md-4">
            ...
            <input type="text" name="start_date" value="{{ old('start_date') }}" class="form-control datetime" id="start_date" autocomplete="off" required />
            @error('start_date')
                <div class="text-danger">{{ $message }}</div>
            @enderror
          </div>
            <div class="form-group col-md-4">
              ...
              <input type="number" min="1" name="total_cost" value="{{ old('total_cost') }}" class="form-control" id="total_cost" required />
              @error('total_cost')
                <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group col-md-4">
                ...
                <input type="number" min="0" step="1" name="working_days" value="{{ old('working_days') }}" class="form-control" id="working_days" required />
                @error('working_days')
                <div class="text-danger">{{ $message }}</div>
                @enderror
              </div>
          ...
          <div class="form-row">
            <div class="form-group col-md-6">
              ...
              <input type="number" min="0" step="1" name="inside_camera" value="{{ old('inside_camera') }}" class="form-control" id="inside_camera" required />
              @error('inside_camera')
                <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group col-md-6">
              ...
              <input type="text" min="0" step="1" name="outside_camera" value="{{ old('outside_camera') }}" class="form-control" id="outside_camera" required />
