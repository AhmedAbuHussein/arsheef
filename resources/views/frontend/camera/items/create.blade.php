...
<div class="container" style="margin-top: 60px">
    ...
    <form method="POST" action="{{ route('items.create', ['type'=> $type, 'parent'=> $parent]) }}">
        @csrf
        ...
        <div class="form-row">
          ...
          <div class="form-group col-md-6">
            ...
            <input type="number" min="1" name="quantity" value="{{ old('quantity') }}" class="form-control" id="quantity" required />
            @error('quantity')
                <div class="text-danger">{{ $message }}</div>
            @enderror
          </div>
        ...
        <div class="form-row">
          <div class="form-group col-md-6">
            ...
            <input type="text" name="type" value="{{ old('type') }}" class="form-control" id="type" required />
            @error('type')
                <div class="text-danger">{{ $message }}</div>
            @enderror
          </div>
          <div class="form-group col-md-6">
            ...
            <input type="text" name="details" value="{{ old('details') }}" class="form-control" id="details" required />
            @error('details')
              <div class="text-danger">{{ $message }}</div>
              @enderror
          </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" name="modal" value="{{ old('modal') }}" class="form-control" id="modal" required />
                @error('modal')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
            <div class="form-group col-md-6">
              ...
              <input type="text" name="storage" value="{{ old('storage') }}" class="form-control" id="storage" />
              @error('storage')
                <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
          ...
          <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <textarea name="other" rows="4" class="form-control" id="other">{{ old('other') }}</textarea>
                @error('other')
                <div class="text-danger">{{ $message }}</div>
                @enderror
              </div>
